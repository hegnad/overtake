      ...
      <div className={styles.main}>
        ...
        <div className={styles.bodyBox}>
          ...
          <div className={styles.section}>
            <h2>RACE LEAGUES</h2>
            <p>
              Create or join a Race League to compete with your friends or other
              fans. Every race weekend, make a set of predictions, and win
              points, trophies, and bragging rights!
            </p>
          </div>
          <div className={styles.section}>
            <h2>FORMULALEARN</h2>
            <p>
              ...
              constructors and circuits. Study historical race data to help make
          ...
          <div className={styles.section}>
            ...
            <p>
              Don’t have time to watch the race? No problem! Visit the Races tab
              to receive live race updates.
            </p>
          </div>
